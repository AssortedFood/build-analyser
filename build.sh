...
echo ""
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}  Done! Run your sandbox:${NC}"
echo ""
echo -e "  ${CYAN}# Interactive bash (then run 'claude' inside):${NC}"
echo -e "  docker run -it --rm -e ANTHROPIC_API_KEY=\$ANTHROPIC_API_KEY $IMAGE_TAG"
echo ""
echo -e "  ${CYAN}# Launch Claude Code directly:${NC}"
echo -e "  docker run -it --rm -e ANTHROPIC_API_KEY=\$ANTHROPIC_API_KEY $IMAGE_TAG claude"
echo ""
echo -e "  ${CYAN}# With permission skip (use with caution):${NC}"
